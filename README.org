...
* Requirements
  ...
  - uv (astral)
  - The following Docker image available locally (Dockerfile available):
...
* Usage
  ...
  #+begin_src bash
  nii2dcm.py -i input_image.nii -o output_dir -d donor.dcm -l "SeriesLabel" -n 101
  #+end_src
  ...
  #+begin_src bash
  nii2dcm.py -i image.nii -o output_dir -d donor.dcm -l "Test" -n 200 -x
  #+end_src
...
* Command-line Arguments
  ...
  | -o   | --output      | Yes | Path to the output DICOM file. |
